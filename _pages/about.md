...
My research focuses on medical image analysis, particularly in image registration, segmentation, and denoising. I work with various imaging modalities, including nuclear medicine imaging (PET and SPECT), CT, and MRI. I am actively involved in the [Medical Image Computing and Computer-Assisted Intervention (MICCAI) Society](https://miccai.org/index.php/) as a committee member of the [MICCAI Special Interest Group in Biomedical Image Registration (SIG-BIR)](https://miccai.org/index.php/special-interest-groups/bir/). I have co-organized the [Learn2Reg](https://learn2reg.grand-challenge.org/) 2024 and 2025 medical image registration challenges at the MICCAI conferences. Additionally, I am deeply engaged with the [Society of Nuclear Medicine and Molecular Imaging (SNMMI)](https://snmmi.org/), where I will serve as a non-voting member of the Board of Directors in the [Physics, Instrumentation & Data Sciences Council (PIDSC)](https://snmmi.org/Web/About/About-SNMMI/Councils/Physics--Instrumentation-and-Data-Sciences-Council/PIDSC-Board-of-Directors.aspx) for a two-year term beginning in July 2025.
...
UPDATES
----
- ***06/13/2025:*** One journal paper was accepted by ***Medical Image Analysis*** for publication!
